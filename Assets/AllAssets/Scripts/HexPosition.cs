...
public class HexPosition : System.IEquatable<HexPosition> {
	...
	private static Dictionary<string, Pair<Color, int>> selectionTypes = new Dictionary<string, Pair<Color, int>>();	//Carries the color and layer of each kind of hex selector.
	...
	private static Dictionary<HexPosition, GameObject> markers = new Dictionary<HexPosition, GameObject>();	//I just made this public for debugging reasons.
	...
	public HexPosition[] Neighbors { get { return new HexPosition[6] {this.N,this.NE,this.SE,this.S,this.SW,this.NW}; } }
	...
	public HexPosition goN(int n) {		return new HexPosition(u+n,		v); }
	public HexPosition goNE(int ne) {	return new HexPosition(u+ne,	v+ne); }
	public HexPosition goSE(int se) {	return new HexPosition(u,		v+se); }
	public HexPosition goS(int s) {		return new HexPosition(u-s,		v); }
	public HexPosition goSW(int sw) {	return new HexPosition(u-sw,	v-sw); }
	public HexPosition goNW(int nw) {	return new HexPosition(u,		v-nw); }
	...
	public int distNE(HexPosition p) { return p.u - u; }
	public int distE(HexPosition p) { return p.u - v; }
	public int distSE(HexPosition p) { return distE (p) - distNE (p); }
	public int distSW(HexPosition p) { return -distNE(p); }
	public int distW(HexPosition p) { return -distE(p); }
	public int distNW(HexPosition p) { return -distSE(p); }
	...
	public string SelectedType {
		...
		private set {
			...
			if(markers.TryGetValue(this, out thisMarker)) {
				thisMarker.renderer.material.color = color;
